...
class SatComprobanteImpuestos(models.Model):
    ...
    tipo_de_cambio_pago = models.DecimalField(max_digits=10, decimal_places=6,default=1.000000)
    sucursal = models.CharField(max_length=255, blank=True, null=True)
    base_excenta = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True, default=0.00)
